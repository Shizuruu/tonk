 ...
 ## GENERAL COMMANDS ##
      #Laplace Specific Commands
        ...
        if message.content.lower() == ('!help'):
            ...
            if not message.channel.name.startswith('mpa'):
                ...
                if (randomNumber == 0):
                    ...
                    yield from client.send_message(message.channel, 'http://i.imgur.com/t7g1GLM.jpg')
                elif (randomNumber == 3):
                    yield from client.send_message(message.channel, 'http://i.imgur.com/4ZecDSf.png')
        ...
        if message.server.id == '159184581830901761':
            ...
            elif message.content.lower() == '!kyoko':
                if not message.channel.name.startswith('mpa'):
                    yield from client.send_message(message.channel, 'http://i.imgur.com/S1ae6DC.jpg')
